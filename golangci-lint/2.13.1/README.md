# Versions
GoLang Linter 2.13.1

# Supported tags and respective `Dockerfile` links
-	[`2.13.1` (*2.13.1/Dockerfile*)](https://github.com/nafigator/docker-library/blob/master/golangci-lint/2.13.1/Dockerfile)
-	[`2.12.2` (*2.12.2/Dockerfile*)](https://github.com/nafigator/docker-library/blob/master/golangci-lint/2.12.2/Dockerfile)
-	[`2.9.0` (*2.9.0/Dockerfile*)](https://github.com/nafigator/docker-library/blob/master/golangci-lint/2.9.0/Dockerfile)

<details>
  <summary>Older versions</summary>

-	[`2.7.2` (*2.7.2/Dockerfile*)](https://github.com/nafigator/docker-library/blob/master/golangci-lint/2.7.2/Dockerfile)
...
```bash
$ docker run --user $(id -u):$(id -g) --rm -ti nafigat0r/golangci-lint:2.13.1 version
```
### Check project
```bash
$ docker run -ti --rm --user "$(id -u):$(id -g)" \
    ...
    -w "/tmp/project" \
    --network host \
    nafigat0r/golangci-lint:2.13.1 run
```
