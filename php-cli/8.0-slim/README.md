...
-	[`8.0-slim` (*8.0-slim/Dockerfile*)](https://github.com/nafigator/docker-library/blob/master/php-cli/8.0-slim/Dockerfile)
...
services:
  php:
    image: nafigat0r/php-cli:8.0-slim
    user: ${UID}:${UID}
    command: script.php
    volumes:
      - ./:/var/www/html/
...
Create Dockerfile:
```dockerfile
FROM nafigat0r/php-cli:8.0-slim
